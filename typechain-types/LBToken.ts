...
export interface LBTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approveForAll"
      | "balanceOf"
...
export interface LBToken extends BaseContract {
  connect(runner?: ContractRunner | null): LBToken;
  waitForDeployment(): Promise<this>;

  interface: LBTokenInterface;
